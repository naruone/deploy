        ...
        <div style="height: calc(100vh - 75px);overflow-y: scroll">
            <el-form :model="cfgForm" :rules="cfgRules" class="drawerForm" label-width="100px"
                ...
                <el-form-item label="AftScript" prop="after_script">
                    <el-input :autosize="{maxRows:10,minRows:4}" type="textarea" v-model="cfgForm.after_script"
                              autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="保留版本" prop="keep_version_cnt">
                    <el-input-number v-model="cfgForm.keep_version_cnt" :min="2" :max="20"></el-input-number>
                </el-form-item>
                <el-form-item>
